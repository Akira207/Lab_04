...
public class productEditServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getServletContext().getRequestDispatcher("/webapp/views/productEdit.jsp");
		String code = (String) request.getParameter("code");
		if(code == null || code=="") {
			errorString="Bạn chọn sản phẩm cần sửa";
		...
		try {
			...
			if(product == null) {
				errorString = "Không tìm thấy sảm phẩm có mã " + code;
			}
		} catch (Exception e) {
			e.printStackTrace();
